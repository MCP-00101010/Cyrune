...
const source = fs.readFileSync(path.join(__dirname, 'media-watchlist-widget.js'), 'utf8');
const calendarSource = fs.readFileSync(path.join(__dirname, '..', 'personal-productivity', 'calendar-widget.js'), 'utf8');
